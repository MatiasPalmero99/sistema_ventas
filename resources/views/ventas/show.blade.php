    ...
    <div class="container-fluid px-4">
        ...
        <div class="container-fluid border border-3 rounded p-5 mt-3">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" value="{{ \Carbon\Carbon::parse($venta->fecha_hora)->format('d-m-Y') }}" disabled>
                </div>
            </div>
             ...
             <div class="row mb-2">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" value="{{ \Carbon\Carbon::parse($venta->fecha_hora)->format('H:i') }}" disabled>
                </div>
            </div>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-8">
                    <input id="impuesto" type="text" class="form-control" value="{{ $venta->impuesto }}" disabled>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($venta->productos as $item)
                                <tr>
                                    ...
                                    <td class="td_subtotal">{{ ($item->pivot->cantidad) * ($item->pivot->precio_venta) - ($item->pivot->descuento) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
