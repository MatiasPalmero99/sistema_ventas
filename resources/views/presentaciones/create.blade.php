        ...
        <div class="container w-50 float-start">
            <form action='{{ route('presentaciones.store') }}' method="POST">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('presentaciones.index') }}"><button type="button" class="btn btn-secondary bg-danger text-white" title="Cancelar" data-bs-dismiss="modal">Cerrar</button></a>
                </div>
            </form>
        </div>
