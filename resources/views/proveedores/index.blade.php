                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @can('editar-proveedore')
                                        <form class="d-inline" action="{{ route('proveedores.edit', ['proveedore' => $item]) }}" method="GET">
                            ...
                            <div class="modal fade" id="confirmModal-{{$item->id}}" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        {{ $item->persona->estado ==1 ? '¿Seguro deseas eliminar este proveedor?' : '¿Seguro deseas restaurar este proveedor?'}}
                                    </div>
